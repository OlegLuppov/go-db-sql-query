...
func main() {
	...
	newClient := Client{
		FIO:      "Тестов Тест Тестович", // укажите ФИО
		Login:    "test",                 // укажите логин
		Birthday: "19930506",             // укажите день рождения
		Email:    "example@mail.com",     // укажите почту
	}
	...
	newLogin := "test111111" // укажите новый логин
